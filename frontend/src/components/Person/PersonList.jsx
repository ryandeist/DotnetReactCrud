...
const PersonList = ({ people, handleEditPerson, handleDeletePerson }) => {
                            ...
                            >
                                ...
                                <td className="px-6 py-4 text-center">
                                    <div className="flex items-center justify-center space-x-2">
                                        <button onClick={() => handleEditPerson(person.personId)}
                                        ...
                                        <button onClick={() => handleDeletePerson(person.personId)}
